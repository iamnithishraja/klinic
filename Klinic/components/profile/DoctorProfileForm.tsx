...
const DoctorProfileForm = ({
  ...
  const consultationTypeOptions = ['online', 'in-person', 'both'];
    ...
    <View>
      ...
      <View className="mb-6">
        ...
        <TouchableOpacity
          ...
          className={`flex items-center justify-center border-2 border-dashed rounded-xl p-4 bg-white ${isCoverImageChanged ? 'border-red-400' : 'border-gray-300'}`}
          style={{ height: 150 }}
        >
          {uploadingCoverImage ? (
