  ...
  return (
    <nav className="w-full bg-white shadow-md fixed top-0 left-0 z-50 flex items-center justify-between px-8 py-3 border-b border-gray-100">
      ...
      <div className="relative">
        ...
        >
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-tint to-blue-500 flex items-center justify-center text-white text-xl font-bold shadow-md">
        ...
        {/* Dropdown */}
        {profileOpen && (
          <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-100 p-6 z-50 animate-fade-in">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-tint to-blue-500 flex items-center justify-center text-white text-2xl font-bold">
                {user.name?.charAt(0).toUpperCase() || <FaUserCircle className="text-2xl" />}
              </div>
              <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <button className="w-full py-2 rounded-lg bg-gray-100 text-gray-700 font-semibold hover:bg-gray-200 transition">Logout</button>
            </div>
          </div>
        )}
      </div>
